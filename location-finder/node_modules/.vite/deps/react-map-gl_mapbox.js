...
var Mapbox = class Mapbox {
	...
	setProps(props) {
		...
		if (settingsChanged) this._createProxyTransform(this._map);
...
function _Map(props, ref) {
	...
	(0, import_react.useEffect)(() => {
		...
		let isMounted = true;
		let mapbox;
		Promise.resolve(mapLib || import("./mapbox-gl-ZFo2iTht.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).then((module) => {
			if (!isMounted) return;
