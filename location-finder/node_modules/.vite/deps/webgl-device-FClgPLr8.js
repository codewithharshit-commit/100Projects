...
function parseUniformName(name) {
	...
	if (!matches || matches.length < 2) throw new Error(`Failed to parse GLSL uniform name ${name}`);
	return {
		name: matches[1],
...
//#endregion
export { Stats as C, lumaStats as S, isBrowser as T, getDataType as _, loadSpectorJS as a, Resource as b, getVariableShaderTypeInfo as c, TextureView as d, Texture as f, alignTo as g, getVertexFormatFromAttribute as h, DEFAULT_SPECTOR_PROPS as i, RenderPipeline as l, Device as m, webgl_device_exports as n, getScratchArrayBuffer as o, Sampler as p, loadWebGLDeveloperTools as r, getAttributeInfosFromLayouts as s, WebGLDevice as t, Shader as u, getTypedArrayConstructor as v, ProbeLog as w, log as x, Buffer as y };

//# sourceMappingURL=webgl-device-FClgPLr8.js.map